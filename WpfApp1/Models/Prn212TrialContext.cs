...
public partial class Prn212TrialContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-AQLBPIV;Initial Catalog=PRN212_Trial; Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true");
