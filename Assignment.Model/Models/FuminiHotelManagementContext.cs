...
namespace Assignment.Model.Models;
...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-AQLBPIV;Initial Catalog=FUMiniHotelManagement; Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740CAFDBD13").IsUnique();
